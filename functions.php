...
if ( ! function_exists( 'cbd_setup' ) ) :
	...
	function cbd_setup() {
		 ...
		 * If you're building a theme based on CBD, use a find and replace
		 * to change 'cbd' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'cbd', get_template_directory() . '/languages' );
 ...
 */
function cbd_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'cbd_content_width', 640 );
}
add_action( 'after_setup_theme', 'cbd_content_width', 0 );
...
function cbd_scripts() {
	...
	wp_enqueue_script( 'cbd-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'cbd-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
